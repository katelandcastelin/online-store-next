...
const corsetProducts = [
  ...
  },
  {
    ...
    images: corsetItems.find(item => item.id === 5).images,
  },
  {
    id: 6,
    ...
    images: corsetItems.find(item => item.id === 6).images,
  },
  {
    id: 7,
    ...
    images: corsetItems.find(item => item.id === 7).images,
  },
  {
    id: 8,
    ...
    images: corsetItems.find(item => item.id === 8).images,
  },
  {
    id: 9,
